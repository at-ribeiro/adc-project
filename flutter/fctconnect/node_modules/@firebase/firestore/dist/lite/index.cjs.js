...
class __PRIVATE_DatastoreImpl extends class Datastore {} {
    ...
    /** Invokes the provided RPC with auth and AppCheck tokens. */    P(t, e, r) {
        return this.Z(), Promise.all([ this.authCredentials.getToken(), this.appCheckCredentials.getToken() ]).then((([n, i]) => this.connection.P(t, e, r, n, i))).catch((t => {
 ...
 */ (n, e), n);
    ...
    registerVersion("firestore-lite", "4.0.0", ""), registerVersion("firestore-lite", "4.0.0", "cjs2017");
}();
