...
class __PRIVATE_RestConnection {
    ...
    T(t, e, r, n, i) {
        const s = __PRIVATE_generateUniqueDebugId(), o = this.R(t, e);
        __PRIVATE_logDebug("RestConnection", `Sending RPC '${t}' ${s}:`, o, r);
        const a = {};
        return this.I(a, n, i), this.V(t, o, a, r).then((e => (__PRIVATE_logDebug("RestConnection", `Received RPC '${t}' ${s}: `, e), 
        e)), (e => {
...
class __PRIVATE_AggregateImpl {
    constructor(t, e, r) {
        this.alias = t, this.v = e, this.fieldPath = r;
    }
}
...
class __PRIVATE_TargetImpl {
    constructor(t, e = null, r = [], n = [], i = null, s = null, o = null) {
        ...
        this.startAt = s, this.endAt = o, this.N = null;
    }
}
...
class __PRIVATE_QueryImpl {
    ...
    constructor(t, e = null, r = [], n = [], i = null, s = "F" /* LimitType.First */ , o = null, a = null) {
        ...
        this.limit = i, this.limitType = s, this.startAt = o, this.endAt = a, this.O = null, 
 ...
 */ function __PRIVATE_queryOrderBy(t) {
    ...
    if (null === e.O) {
        ...
        t.isKeyField() || e.O.push(new OrderBy(t)), e.O.push(new OrderBy(FieldPath$1.keyField(), "asc" /* Direction.ASCENDING */)); else {
            let t = !1;
            for (const r of e.explicitOrderBy) e.O.push(r), r.field.isKeyField() && (t = !0);
            if (!t) {
                // The order of the implicit key ordering always matches the last
                // explicit order by
                const t = e.explicitOrderBy.length > 0 ? e.explicitOrderBy[e.explicitOrderBy.length - 1].dir : "asc" /* Direction.ASCENDING */;
                e.O.push(new OrderBy(FieldPath$1.keyField(), t));
            }
        }
    }
    return e.O;
 ...
 */ function __PRIVATE_queryToTarget(t) {
    const e = __PRIVATE_debugCast(t);
    if (!e.q) if ("F" /* LimitType.First */ === e.limitType) e.q = __PRIVATE_newTarget(e.path, e.collectionGroup, __PRIVATE_queryOrderBy(e), e.filters, e.limit, e.startAt, e.endAt); else {
        ...
        e.q = __PRIVATE_newTarget(e.path, e.collectionGroup, t, e.filters, e.limit, r, n);
    }
    return e.q;
}
...
class __PRIVATE_DatastoreImpl extends class Datastore {} {
    ...
    /** Invokes the provided RPC with auth and AppCheck tokens. */    T(t, e, r) {
        return this.Z(), Promise.all([ this.authCredentials.getToken(), this.appCheckCredentials.getToken() ]).then((([n, i]) => this.connection.T(t, e, r, n, i))).catch((t => {
    ...
    /** Invokes the provided RPC with streamed results with auth and AppCheck tokens. */    p(t, e, r, n) {
        return this.Z(), Promise.all([ this.authCredentials.getToken(), this.appCheckCredentials.getToken() ]).then((([i, s]) => this.connection.p(t, e, r, i, s, n))).catch((t => {
            throw "FirebaseError" === t.name ? (t.code === w && (this.authCredentials.invalidateToken(), 
            this.appCheckCredentials.invalidateToken()), t) : new FirestoreError(T, t.toString());
        }));
    }
...
async function __PRIVATE_invokeRunQueryRpc(t, e) {
    ...
    return (await r.p("RunQuery", n.parent, {
...
async function __PRIVATE_invokeRunAggregationQueryRpc(t, e, r) {
    ...
    const u = (await i.p("RunAggregationQuery", a, s, /*expectedResponseCount=*/ 1)).filter((t => !!t.result));
...
/** A "context" object passed around while parsing user data. */ class __PRIVATE_ParseContextImpl {
    ...
    _t(t) {
        return __PRIVATE_createError(t, this.settings.methodName, this.settings.lt || !1, this.path, this.settings.ct);
    }
...
class __PRIVATE_TransactionRunner {
    ...
    Rt(t) {
        this.Et > 0 && this.It(t) ? (this.Et -= 1, this.asyncQueue.enqueueAndForget((() => (this.Pt(), 
 ...
 */ (n, e), n);
    ...
    n("firestore-lite", "4.0.0", "rn"), n("firestore-lite", "4.0.0", "esm2017");
}();
