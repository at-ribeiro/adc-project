 ...
 * limitations under the License.
 */
var g = "10.0.0", w = new l("@firebase/firestore");
...
var wt = /** @class */ function(r) {
    ...
    function i(t, e) {
        var n = this;
        return (n = r.call(this, t) || this).g = e, n;
    }
    /**
     * Base class for all Rest-based connections to the backend (WebChannel and
     * HTTP).
     */
    return t(i, r), i.prototype.F = function(t, e) {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return n.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.g(r, {
                        method: "POST",
                        headers: i,
                        body: e
                    }) ];
    ...
    function t(t) {
        ...
        this.m = e + "://" + t.host, this.A = "projects/" + this.databaseId.projectId + "/databases/" + this.databaseId.database + "/documents";
    }
    return Object.defineProperty(t.prototype, "T", {
        ...
        "0x" + ht.toString(16)), a = this.R(t, e);
        b("RestConnection", "Sending RPC '".concat(t, "' ").concat(o, ":"), a, n);
        var u = {};
        return this.I(u, r, i), this.V(t, a, u, n).then((function(e) {
    ...
    this.alias = t, this.v = e, this.fieldPath = n;
};
...
var ye = /** @class */ function() {
    ...
    this.startAt = o, this.endAt = a, this.N = null;
};
 ...
 */ function Ie(t) {
    ...
    if (null === e.O) {
        ...
        n.isKeyField() || e.O.push(new ce(n)), e.O.push(new ce(rt.keyField(), "asc" /* Direction.ASCENDING */)); else {
 ...
 */ function Ae(t) {
    var e = A(t);
    if (!e.q) if ("F" /* LimitType.First */ === e.limitType) e.q = be(e.path, e.collectionGroup, Ie(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        ...
        // Now return as a LimitType.First query.
                e.q = be(e.path, e.collectionGroup, n, e.filters, e.limit, u, s);
    }
    return e.q;
}
...
}(), Ce = function() {}, Le = /** @class */ function(e) {
    function n(t, n, r, i) {
        void 0 === i && (i = []);
        var o = this;
 ...
 */ var hn = /** @class */ function() {
    ...
    /** Invokes the provided RPC with auth and AppCheck tokens. */ n.prototype.P = function(t, e, n) {
        var r = this;
        return this.Z(), Promise.all([ this.authCredentials.getToken(), this.appCheckCredentials.getToken() ]).then((function(i) {
            var o = i[0], a = i[1];
            return r.connection.P(t, e, n, o, a);
        })).catch((function(t) {
 ...
 */ function Fn(t, e) {
    ...
    if (!(t instanceof An || t instanceof Pn)) throw new B(O, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
...
function Vn(t, e) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = Tt.D()), ot("doc", "path", e), t instanceof wn) {
        var o = et.fromString.apply(et, r([ e ], n, !1));
...
/** A "context" object passed around while parsing user data. */ var zn = /** @class */ function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.rt = function(e) {
        ...
        return cr(t, this.settings.methodName, this.settings.lt || !1, this.path, this.settings.ct);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (Bn(this.et) && jn.test(t)) throw this._t('Document fields cannot begin and end with "__"');
    }, t;
}(), Gn = /** @class */ function() {
    function t(t, e, n) {
...
/** Parse update data from a list of field/value arguments. */ function tr(t, e, n, r, i, o) {
    var a = t.ht(1 /* UserDataSource.Update */ , e, n), u = [ ar(e, r, n) ], s = [ i ];
 ...
 */ function er(t, e, n, r) {
    return void 0 === r && (r = !1), nr(n, t.ht(r ? 4 /* UserDataSource.ArrayArgument */ : 3 /* UserDataSource.Argument */ , e));
}
 ...
 */ function nr(t, e) {
    ...
    return function(t, e) {
        ...
        if (!Bn(e.et)) throw e._t("".concat(t._methodName, "() can only be used with update() and set()"));
...
function ir(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof Dt || t instanceof Ln || t instanceof qn || t instanceof An || t instanceof Cn);
}
...
var Br = /** @class */ function(e) {
    ...
    t.prototype.convertObjectMap = function(t, e) {
        ...
        return new Ln(Vt(t.latitude), Vt(t.longitude));
    ...
    return function(t, r) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return e = A(t), i = nn(e.serializer, Ae(r)), [ 4 /*yield*/ , e.p("RunQuery", i.parent, {
...
function Kr(t, e, n) {
    var r = Ur((t = ct(t, An)).converter, e, n), i = Qn(Kn(t.firestore), "setDoc", t._key, r, null !== t.converter, n);
 ...
 */ function Yr(t, e) {
    var n = Vn(t = ct(t, Pn)), r = Ur(t.converter, e), i = Qn(Kn(t.firestore), "addDoc", n._key, r, null !== n.converter, {});
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    }(o.serializer, Ae(r), i), u = a.request, s = a.X, c = u.parent, o.connection.T || delete u.parent, 
                    [ 4 /*yield*/ , o.p("RunAggregationQuery", c, u, /*expectedResponseCount=*/ 1) ];
    ...
    return t.prototype.run = function() {
        ...
        this.At.G((function() {
            return e(t, void 0, void 0, (function() {
                var t, e, r = this;
                return n(this, (function(n) {
                    return t = new li(this.datastore), (e = this.Pt(t)) && e.then((function(e) {
...
a("firestore-lite", "4.0.0", ""), a("firestore-lite", "4.0.0", "esm5");
