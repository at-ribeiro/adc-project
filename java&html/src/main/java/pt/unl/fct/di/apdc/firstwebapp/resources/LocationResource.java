...
public class LocationResource {
    ...
    public Response getLocations(@HeaderParam("Authorization") String tokenId, @HeaderParam("User") String username) {
        ...
        try{
            ...
            List<Value<String>> DEFAULT_TYPES = new ArrayList<>();

            DEFAULT_TYPES.add(StringValue.newBuilder("EDIFICIOS").build());
            DEFAULT_TYPES.add(StringValue.newBuilder("TRANSPORTE").build());
            DEFAULT_TYPES.add(StringValue.newBuilder("RESTAURACAO").build());

            List<LocationData> locations = new ArrayList<>();

            Query<Entity> query = Query.newEntityQueryBuilder()
                    .setKind("Location")
                    .setFilter(StructuredQuery.PropertyFilter.in("type", ListValue.of(DEFAULT_TYPES)))
                    .build();
