...
public class ChangePwdResource {
    ...
    @PUT
    @Path("/forgotpwd/{username}")
    @Consumes(MediaType.APPLICATION_JSON)
    public Response forgotPwd(@HeaderParam("Authorization") String tokenId, @PathParam("username") String username,
                              @QueryParam("code") String code, @QueryParam("newpwd") String newpwd){
